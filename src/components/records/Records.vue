<template>
  <div class="max-w-md m-auto py-10">
    ...
    <h3 class="font-mono font-regular text-3xl mb-4">Add Educational Details</h3>

    <form @submit.prevent="addRecord">
      <div class="mb-6">
        <label for="record_title" class="label">Degree</label>
        <input
          type="text"
          id="record_title"
          class="input"
      ...
      <div class="mb-6">
        <label for="record_year" class="label">Year of Passing</label>
        <input
          type="text"
          id="record_year"
          class="input"
      ...
      <div class="mb-6">
        <label for="artist" class="label">College</label>
        ...
        <p class="pt-4">Don't see a College? <router-link to="/artists" class="link-grey">Create one</router-link></p>
      </div>
